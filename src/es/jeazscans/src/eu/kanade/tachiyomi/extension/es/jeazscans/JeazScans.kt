...
class JeazScans : HttpSource() {
    ...
    private class GenreFilter :
        Filter.Group<GenreCheckBox>(
            "Géneros",
            listOf(
                GenreCheckBox("Acción"),
                GenreCheckBox("Artes marciales"),
                GenreCheckBox("Aventura"),
                GenreCheckBox("Cazadores"),
                GenreCheckBox("Ciencia Ficción"),
                GenreCheckBox("Comedia"),
                GenreCheckBox("Crimen"),
                GenreCheckBox("cultivacion"),
                GenreCheckBox("Cultivo"),
                GenreCheckBox("Demonios"),
                GenreCheckBox("Deportes"),
                GenreCheckBox("Drama"),
                GenreCheckBox("Ecchi"),
                GenreCheckBox("Escolar"),
                GenreCheckBox("Familia"),
                GenreCheckBox("Fantasía"),
                GenreCheckBox("Gore"),
                GenreCheckBox("Harem"),
                GenreCheckBox("harén"),
                GenreCheckBox("Histórico"),
                GenreCheckBox("Isekai"),
                GenreCheckBox("Josei"),
                GenreCheckBox("Magia"),
                GenreCheckBox("Manga"),
                GenreCheckBox("Manhua"),
                GenreCheckBox("Manhwa"),
                GenreCheckBox("Mecha"),
                GenreCheckBox("Militar"),
                GenreCheckBox("Misterio"),
                GenreCheckBox("Murim"),
                GenreCheckBox("Policiaco"),
                GenreCheckBox("Post-Apocalíptico"),
                GenreCheckBox("Psicológico"),
                GenreCheckBox("Realidad Virtual"),
                GenreCheckBox("Recuentos de la vida"),
                GenreCheckBox("Reencarnación"),
                GenreCheckBox("Regresión"),
                GenreCheckBox("Romance"),
                GenreCheckBox("Seinen"),
                GenreCheckBox("Shonen"),
                GenreCheckBox("Shoujo"),
                GenreCheckBox("Sistemas"),
                GenreCheckBox("Sobrenatural"),
                GenreCheckBox("Superpoderes"),
                GenreCheckBox("Supervivencia"),
                GenreCheckBox("Terror"),
                GenreCheckBox("Torre"),
                GenreCheckBox("Tragedia"),
                GenreCheckBox("Transmigración"),
                GenreCheckBox("Vampiros"),
                GenreCheckBox("Venganza"),
                GenreCheckBox("Viaje en el tiempo"),
                GenreCheckBox("Videojuegos"),
                GenreCheckBox("Wuxia"),
                GenreCheckBox("Xianxia"),
                GenreCheckBox("Xuanhuan"),
